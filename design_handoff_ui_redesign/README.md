...
- Brand: 34px rounded-9px tile, saffron→red gradient, containing a white **shield + cross** line icon (stroke 2, 19px); title 15/600 white "Transport Sahayak" + subtitle 11px `#7D8DA9` "Delhi–Dehradun Expressway — Road Accident First Response".
...
3. **ETA** card (green-soft): caps "Estimated ambulance arrival"; "Ambulance inbound from Baraut · 2 ambulances (BLS)"; "~34 min · 19.3 km — based on current road distance"; right: live `mm:ss` countdown 26/700 green tabular-nums + "MIN : SEC REMAINING"; 6px progress bar; disclaimer "Calculated estimate — not live tracking. We do not track vehicles."
4. **Matched hospitals**: caps header + right hint "traffic time · trauma · specialty". Ranked rows: 24px rank circle (rank 1 = navy filled; card gets 1.5px blue border + `#F7FAFE` bg), name 13.5/600 + saffron "Unverified" pill + one-line 12px note; right-aligned bold blue minutes over "km · current traffic". Data: Ramkali Devi Memorial 19 min/7.6 km; Daha Govt Hospital 24 min/13.0 km; CHC Tikri 27 min/9.8 km. Green footnote: "✓ Drive times from Routes API — current traffic, vehicle leaving now. We do not track ambulances."
5. Two-up grid: **Nearest police station** card (Baghpat Highway Police Chowki, NH-334 North circle, bold blue 54 min · 42.8 km, tel link 01232-261100) + **Routes on map** legend (solid blue = hospital, dashed navy = police, dashed green = ambulance).
