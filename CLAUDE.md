...
ENGLISH_TTS_VOICE_NAME=en-IN-Chirp3-HD-Charon   # same named voice model as GEMINI_LIVE_VOICE_NAME above -- closest achievable cross-engine match; en-IN-Neural2-D (old default) was FEMALE, a mismatch
